% ---------<<Custom Made LaTeX Preamble-inspired by evan chen's package>>---------
% ---<<Packages>>---
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\textbb{My Math Memoir}}
\fancyhead[L]{rotten $\int$ntegral \texttt{(Last Updated $-$ \today)}}
...
% ---<<Theorem Box - With no title>>---
\newtcolorbox{notitthm}[1]{%
	colback=turquoiseblue!5!white,
	colframe=ultramarine!90!black,
	coltitle=ultramarine!90!black,
	fonttitle=\bfseries,
...
% ---<<Lemma Box>>---
\newtcolorbox{lemma}[1]{%
	colback=peach-orange!10!white,
	colframe=darkolivegreen!75!black,
	coltitle=darkolivegreen!75!black,
	fonttitle=\bfseries,
	colbacktitle=peach-orange!10!white,
	enhanced,
	boxrule=0.5pt,
	acr=4pt,
	attach title to upper,
	title={Lemma #1.$\hspace{1mm}$}
}
...
\newtcolorbox{proposition}[1]{%
	...
	arc=4pt,
	attach title to upper,
	title={Proposition #1.$\hspace{1mm}$}
}

% ---<<Example Box>>---
\newtcolorbox{example}[2]{%
	colback=lavenderpurple!10!white,
	colframe=palatinatepurple!75!black,
	coltitle=palatinatepurple!75!black,
	fonttitle=\bfseries,
	colbacktitle=lavenderpurple!10!white,
	enhanced,
	boxrule=0.5pt,
	sharp corners,
	attach title to upper,
...
% ---<<Olive Green Rubrication>>---
\newcommand{\olivegreenhighlight}[1]{\par\noindent\textbf{\textcolor{darkolivegreen}{\ding{161} #1 $\hspace{1mm}$}}}
...
\newenvironment{solution}{%
  \noindent\newline
  \textbf{Solution.$\hspace{1mm}$}
  \noindent
}{$\vspace{0.3cm}$}

% ---<<Numbered Solution Environment>>---
\newenvironment{numsolution}[1]{%
  \noindent\newline
  \textbf{Solution #1.$\hspace{1mm}$}
  \noindent
}{$\vspace{0.3cm}$}
...
\renewcommand{\thechapter}{\textcolor{raspberry}{\Roman{chapter}}}
